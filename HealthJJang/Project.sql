...
drop table manager;
drop table health_shooes;
drop table attendance;
drop table shoppingbasket;

drop table orderer;
drop table product_option;
drop table orderation;
drop table product;
...
(
	...
	product_amount number(10) not null,
	product_explain varchar2(50) not null,
	CODE varchar2(50) not null,
	image_Name varchar2(20),
	image_comment varchar2(20),
	image_comment2 varchar2(20),
	image_comment3 varchar2(20),
	image_comment4 varchar2(20)
)
...
create table shoppingbasket(
	product_no number(10) constraint health_fk3 references product,
...
create table productoption(
	...
	product_no number(10) constraint health_fk10 references product,
	product_Size varchar2(30),
	productFrame varchar2(30)
