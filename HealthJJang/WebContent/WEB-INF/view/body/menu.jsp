				...
				<li class="navi_set">  
						...
						<c:if test="${not empty sessionScope.managerID}">
							<c:if test="${not empty sessionScope.managerPW}">
								<li onclick="top.location.href='main.do';">로그아웃</li> 
							</c:if>
						</c:if>
						</ul>  
					</li>
					...
					<li class="navi_set">  
						...
						<ul class="subnav">  
							...
							<c:if test="${not empty sessionScope.managerID}">
								<c:if test="${not empty sessionScope.managerPW}">
									<li onclick="top.location.href='/HealthJJang/OrderAdmin.do';">주문관리</li> 
									
									<li onclick="top.location.href='/HealthJJang/addItemController.do';">등록</li>  
								</c:if>
							</c:if>
							
								<li onclick="top.location.href='/HealthJJang/ViewCartList.do';">장바구니</li>  
								
								<li onclick="top.location.href='/HealthJJang/ViewOrderer.do';">물품조회</li>  
